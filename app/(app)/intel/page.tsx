...
import { TrendingUp, Activity, PieChart, FileText, Settings, BarChart3, Target, ListChecks } from "lucide-react";
...
export default function IntelPage() {
  ...
  const sections = [
    ...
    // Elite Achievements moved to the Reports (Service Record) page
