...
const STATIC_CACHE = "barrax-static-v13";
const NAV_CACHE = "barrax-nav-v8";
...
// Activate — clean up old caches (preserve NAV_CACHE so users don't
// lose their offline shell on a code deploy). The legacy AUDIO_CACHE
// from the old AI coach is intentionally NOT kept and will be deleted.
